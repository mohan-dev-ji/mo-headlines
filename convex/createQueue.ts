...
6. Generate 3 detailed image generation prompts for visual content
...
- SCIENTIFIC CONTENT: For research/science articles, create detailed microscopic imagery, abstract compositions
...
[
  {
    ...
    "imageGenPrompts": [
      "Detailed 50-150 word prompt creating unique photorealistic composition with specific lighting, camera angles, and environmental context relevant to the story",
      ...
      "Detailed 50-150 word prompt for editorial-style imagery with professional photojournalism approach, specific visual metaphors, and contextual elements from the story"
    ]
