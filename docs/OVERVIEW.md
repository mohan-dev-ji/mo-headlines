...
- **Editor/Admin**: Creates content through multiple workflows (RSS, research, YouTube), reviews and approves articles, manages content pipeline

## Success Metrics
- Article engagement and topic discovery usage
...
- **Review**: Content approval, editing, publishing pipeline
- **Consume**: Article browsing, topic exploration, user engagement